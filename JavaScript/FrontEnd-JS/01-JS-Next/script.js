...
//Однако нельзя начинать объявление переменной с цияфры!!
const camelCaseVariable = 'I like it!';//CamelCase - такой способ именования переменной что каждое новое слово кроме первого начинается с заглавной буквы
...
//const stringInterpolation = `${varredData}`; Такая конструкция называется интерполяция строк, в рамках фигурных скобок можно использовать любые выражения JavaScript!
